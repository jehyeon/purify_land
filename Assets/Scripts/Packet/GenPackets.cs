...
public class S_PlayerList : IPacket
{
	public class Player
	{
		...
		{
			this.isHost = BitConverter.ToBoolean(segment.Array, segment.Offset + count);
			count += sizeof(bool);
		...
		{
			bool success = true;
			Array.Copy(BitConverter.GetBytes(this.isHost), 0, segment.Array, segment.Offset + count, sizeof(bool));
			count += sizeof(bool);
	...
	public ArraySegment<byte> Write()
	{
		...
		count += sizeof(ushort);
		Array.Copy(BitConverter.GetBytes((ushort)this.playerList.Count), 0, segment.Array, segment.Offset + count, sizeof(ushort));
		count += sizeof(ushort);
...
public class C_Act : IPacket
{
	public int actionType;
	public bool right;

	public ushort Protocol { get { return (ushort)PacketID.C_Act; } }
	...
	public ArraySegment<byte> Write()
	{
		...
		count += sizeof(ushort);
		Array.Copy(BitConverter.GetBytes((ushort)PacketID.C_Act), 0, segment.Array, segment.Offset + count, sizeof(ushort));
		count += sizeof(ushort);
...
public class S_BroadcastAct : IPacket
{
	public int playerId;
	public int actionType;
	public bool right;

	public ushort Protocol { get { return (ushort)PacketID.S_BroadcastAct; } }
	...
	public ArraySegment<byte> Write()
	{
		...
		count += sizeof(ushort);
		Array.Copy(BitConverter.GetBytes((ushort)PacketID.S_BroadcastAct), 0, segment.Array, segment.Offset + count, sizeof(ushort));
		count += sizeof(ushort);
		Array.Copy(BitConverter.GetBytes(this.playerId), 0, segment.Array, segment.Offset + count, sizeof(int));
		count += sizeof(int);
		Array.Copy(BitConverter.GetBytes(this.actionType), 0, segment.Array, segment.Offset + count, sizeof(int));
...
public class C_PlayerHp : IPacket
{
	public int playerId;
	public int hp;
	public int maxHp;

	public ushort Protocol { get { return (ushort)PacketID.C_PlayerHp; } }
	...
	public ArraySegment<byte> Write()
	{
		...
		count += sizeof(ushort);
		Array.Copy(BitConverter.GetBytes((ushort)PacketID.C_PlayerHp), 0, segment.Array, segment.Offset + count, sizeof(ushort));
		count += sizeof(ushort);
		Array.Copy(BitConverter.GetBytes(this.playerId), 0, segment.Array, segment.Offset + count, sizeof(int));
		count += sizeof(int);
		Array.Copy(BitConverter.GetBytes(this.hp), 0, segment.Array, segment.Offset + count, sizeof(int));
...
public class S_BroadcastPlayerHp : IPacket
{
	public int playerId;
	public int hp;
	public int maxHp;

	public ushort Protocol { get { return (ushort)PacketID.S_BroadcastPlayerHp; } }
	...
	public ArraySegment<byte> Write()
	{
		...
		count += sizeof(ushort);
		Array.Copy(BitConverter.GetBytes((ushort)PacketID.S_BroadcastPlayerHp), 0, segment.Array, segment.Offset + count, sizeof(ushort));
		count += sizeof(ushort);
		Array.Copy(BitConverter.GetBytes(this.playerId), 0, segment.Array, segment.Offset + count, sizeof(int));
		count += sizeof(int);
		Array.Copy(BitConverter.GetBytes(this.hp), 0, segment.Array, segment.Offset + count, sizeof(int));
...
public class S_EnemyList : IPacket
{
	...
	public ArraySegment<byte> Write()
	{
		...
		count += sizeof(ushort);
		Array.Copy(BitConverter.GetBytes((ushort)this.enemyList.Count), 0, segment.Array, segment.Offset + count, sizeof(ushort));
		count += sizeof(ushort);
...
public class C_SpawnCallEnemy : IPacket
{
	public int enemyId;
	public float posX;
	public float posY;

	public ushort Protocol { get { return (ushort)PacketID.C_SpawnCallEnemy; } }
	...
	public ArraySegment<byte> Write()
	{
		...
		count += sizeof(ushort);
		Array.Copy(BitConverter.GetBytes((ushort)PacketID.C_SpawnCallEnemy), 0, segment.Array, segment.Offset + count, sizeof(ushort));
		count += sizeof(ushort);
		Array.Copy(BitConverter.GetBytes(this.enemyId), 0, segment.Array, segment.Offset + count, sizeof(int));
		count += sizeof(int);
		Array.Copy(BitConverter.GetBytes(this.posX), 0, segment.Array, segment.Offset + count, sizeof(float));
...
public class S_BroadcastSpawnEnemy : IPacket
{
	public int enemyId;
	public int id;
	public float posX;
	...
	public ushort Protocol { get { return (ushort)PacketID.S_BroadcastSpawnEnemy; } }
	...
	public ArraySegment<byte> Write()
	{
		...
		count += sizeof(ushort);
		Array.Copy(BitConverter.GetBytes((ushort)PacketID.S_BroadcastSpawnEnemy), 0, segment.Array, segment.Offset + count, sizeof(ushort));
		count += sizeof(ushort);
		Array.Copy(BitConverter.GetBytes(this.enemyId), 0, segment.Array, segment.Offset + count, sizeof(int));
		count += sizeof(int);
		Array.Copy(BitConverter.GetBytes(this.id), 0, segment.Array, segment.Offset + count, sizeof(int));
...
public class C_EnemyTarget : IPacket
{
	public int id;
	public int playerId;

	public ushort Protocol { get { return (ushort)PacketID.C_EnemyTarget; } }
	...
	public ArraySegment<byte> Write()
	{
		...
		count += sizeof(ushort);
		Array.Copy(BitConverter.GetBytes((ushort)PacketID.C_EnemyTarget), 0, segment.Array, segment.Offset + count, sizeof(ushort));
		count += sizeof(ushort);
		Array.Copy(BitConverter.GetBytes(this.id), 0, segment.Array, segment.Offset + count, sizeof(int));
		count += sizeof(int);
		Array.Copy(BitConverter.GetBytes(this.playerId), 0, segment.Array, segment.Offset + count, sizeof(int));
...
public class S_BroadcastEnemyTarget : IPacket
{
	public int id;
	public int playerId;

	public ushort Protocol { get { return (ushort)PacketID.S_BroadcastEnemyTarget; } }
	...
	public ArraySegment<byte> Write()
	{
		...
		count += sizeof(ushort);
		Array.Copy(BitConverter.GetBytes((ushort)PacketID.S_BroadcastEnemyTarget), 0, segment.Array, segment.Offset + count, sizeof(ushort));
		count += sizeof(ushort);
		Array.Copy(BitConverter.GetBytes(this.id), 0, segment.Array, segment.Offset + count, sizeof(int));
		count += sizeof(int);
		Array.Copy(BitConverter.GetBytes(this.playerId), 0, segment.Array, segment.Offset + count, sizeof(int));
...
public class C_EnemyState : IPacket
{
	public int id;
	public int state;

	public ushort Protocol { get { return (ushort)PacketID.C_EnemyState; } }
	...
	public ArraySegment<byte> Write()
	{
		...
		count += sizeof(ushort);
		Array.Copy(BitConverter.GetBytes((ushort)PacketID.C_EnemyState), 0, segment.Array, segment.Offset + count, sizeof(ushort));
		count += sizeof(ushort);
		Array.Copy(BitConverter.GetBytes(this.id), 0, segment.Array, segment.Offset + count, sizeof(int));
		count += sizeof(int);
...
public class S_BroadcastEnemyState : IPacket
{
	public int id;
	public int state;

	public ushort Protocol { get { return (ushort)PacketID.S_BroadcastEnemyState; } }
	...
	public ArraySegment<byte> Write()
	{
		...
		count += sizeof(ushort);
		Array.Copy(BitConverter.GetBytes((ushort)PacketID.S_BroadcastEnemyState), 0, segment.Array, segment.Offset + count, sizeof(ushort));
		count += sizeof(ushort);
		Array.Copy(BitConverter.GetBytes(this.id), 0, segment.Array, segment.Offset + count, sizeof(int));
		count += sizeof(int);
		Array.Copy(BitConverter.GetBytes(this.state), 0, segment.Array, segment.Offset + count, sizeof(int));
...
public class C_EnemyHp : IPacket
{
	public int id;
	public int hp;
	public int maxHp;

	public ushort Protocol { get { return (ushort)PacketID.C_EnemyHp; } }
	...
	public ArraySegment<byte> Write()
	{
		...
		count += sizeof(ushort);
		Array.Copy(BitConverter.GetBytes((ushort)PacketID.C_EnemyHp), 0, segment.Array, segment.Offset + count, sizeof(ushort));
		count += sizeof(ushort);
		Array.Copy(BitConverter.GetBytes(this.id), 0, segment.Array, segment.Offset + count, sizeof(int));
		count += sizeof(int);
		Array.Copy(BitConverter.GetBytes(this.hp), 0, segment.Array, segment.Offset + count, sizeof(int));
...
public class S_BroadcastEnemyHp : IPacket
{
	public int id;
	public int hp;
	public int maxHp;

	public ushort Protocol { get { return (ushort)PacketID.S_BroadcastEnemyHp; } }
	...
	public ArraySegment<byte> Write()
	{
		...
		count += sizeof(ushort);
		Array.Copy(BitConverter.GetBytes((ushort)PacketID.S_BroadcastEnemyHp), 0, segment.Array, segment.Offset + count, sizeof(ushort));
		count += sizeof(ushort);
		Array.Copy(BitConverter.GetBytes(this.id), 0, segment.Array, segment.Offset + count, sizeof(int));
		count += sizeof(int);
		Array.Copy(BitConverter.GetBytes(this.hp), 0, segment.Array, segment.Offset + count, sizeof(int));
